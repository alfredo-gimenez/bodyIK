...
Body::Body()
{
	...
	mBodyParts[SPINE]->addSegment(20.0,20.0,M_PI_2,M_PI_4/2.0,M_PI_2+M_PI_4/2.0);
	mBodyParts[SPINE]->addSegment(25.0,30.0,0.0,-M_PI_4/2.0,M_PI_4/2.0);
	mBodyParts[SPINE]->addSegment(25.0,30.0,0.0,-M_PI_4/2.0,M_PI_4/2.0);
	mBodyParts[SPINE]->addSegment(10.0,10.0,0.0,-M_PI_4/2.0,M_PI_4/2.0);
	mBodyParts[SPINE]->addSegment(40.0,20.0,0.0,-M_PI_4/2.0,M_PI_4/2.0);
	...
	mBodyParts[LEFT_ARM]->addSegment(40.0,10.0,-M_PI,-M_PI-M_PI_4,-M_PI+M_PI_4);
	mBodyParts[LEFT_ARM]->addSegment(60.0,10.0,M_PI_2,M_PI_2-M_PI_2,M_PI_2+M_PI_2);
	mBodyParts[LEFT_ARM]->addSegment(60.0,10.0,-M_PI/6.0);
	mBodyParts[LEFT_ARM]->addSegment(15.0,10.0,-M_PI/6.0);
	mBodyParts[LEFT_ARM]->resetIK();

	mBodyParts[RIGHT_ARM] = new IKchain(&mBodyParts[SPINE]->mPositions[3]);
	mBodyParts[RIGHT_ARM]->addSegment(40.0,10.0,0.0,-M_PI_4,M_PI_4);
	mBodyParts[RIGHT_ARM]->addSegment(60.0,10.0,-M_PI_2,-M_PI_2,M_PI_2);
	mBodyParts[RIGHT_ARM]->addSegment(60.0,10.0,M_PI/6.0);
	mBodyParts[RIGHT_ARM]->addSegment(15.0,10.0,M_PI/6.0);
	mBodyParts[RIGHT_ARM]->resetIK();

	mBodyParts[LEFT_LEG] = new IKchain(&mPos);
	mBodyParts[LEFT_LEG]->addSegment(25.0,15.0,(-M_PI_2 - M_PI_4),-M_PI,(-M_PI_2 - M_PI_4));
	mBodyParts[LEFT_LEG]->addSegment(70.0,15.0,M_PI_4,0,M_PI_4);
	mBodyParts[LEFT_LEG]->addSegment(70.0,10.0,0.0,0.0,M_PI_2);
	mBodyParts[LEFT_LEG]->addSegment(10.0,10.0,-M_PI_4);
	mBodyParts[LEFT_LEG]->resetIK();

	mBodyParts[RIGHT_LEG] = new IKchain(&mPos);
	mBodyParts[RIGHT_LEG]->addSegment(25.0,15.0,-M_PI_4,-M_PI_4,0);
	mBodyParts[RIGHT_LEG]->addSegment(70.0,15.0,-M_PI_4,-M_PI_2,0);
	mBodyParts[RIGHT_LEG]->addSegment(70.0,10.0,0.0,-M_PI_2,0.0);
	mBodyParts[RIGHT_LEG]->addSegment(10.0,10.0,M_PI_4);
